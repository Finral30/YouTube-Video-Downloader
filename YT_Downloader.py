        ...
        # =========================================================
            ...
            if not video_stream:
                ...
                app.after(
                    0,
                    lambda: status_label.configure(
                        text=f"{quality} unavailable, using closest quality..."
                    )
                )
                ...
                for stream in video_streams:
                    ...
                    if stream_quality <= requested_quality:
                        video_stream = stream
                        break
            ...
            if not video_stream:
                raise Exception(
                    "No compatible video stream found."
                )
            ...
            app.after(
                0,
                lambda: status_label.configure(
                    text=f"Downloading {video_stream.resolution} video..."
                )
            )
            ...
            app.after(0, progress_bar.set, 0)
